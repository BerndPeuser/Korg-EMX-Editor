...
type
  ...
  TMainForm = class(TForm)
    ...
    NotesGatesSynth2: TValueListEditor;
    NotesGatesSynth3: TValueListEditor;
    NotesGatesSynth4: TValueListEditor;
    NotesGatesSynth5: TValueListEditor;
    ...
    NotesGatesSynth1: TValueListEditor;
